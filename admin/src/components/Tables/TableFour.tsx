...
const TableFour: React.FC<TableFourProps> = ({ productData, totalPages, currentPage, titleName, setCurrentPage, toggleAction }) => {
  ...
  return (
    <div className="rounded-md border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      ...
      <div className="grid grid-cols-6 border-t border-stroke py-4.5 px-4 dark:border-strokedark sm:grid-cols-7 lg:grid-cols-8 md:px-6 2xl:px-7.5">
      ...
      {productData.map((product, key) => (
        <div
          className={`grid grid-cols-6 border-t border-stroke py-4.5 px-4 dark:border-strokedark sm:grid-cols-7 lg:grid-cols-8 md:px-6 2xl:px-7.5  ${key % 2 === 0 ? "bg-slate-200 dark:bg-slate-600" : "bg-white dark:bg-boxdark"}`}
          key={key}
        >
          <div className="col-span-3 flex items-center">
