        ...
        <DefaultLayout>
            ...
            <div className="grid grid-cols-1 mt-6 gap-4 md:grid-cols-3 md:gap-6 xl:grid-cols-5 2xl:gap-7.5">
                {responseData && responseData.map((category, index) => (
                    <div key={index} className="p-0 mx-10 sm:mx-30 md:mx-0 bg-gray-200 rounded-lg shadow-xl duration-300 from-blue-600 to-purple-600   ">
                        <div className="overflow-hidden hover:relative aspect-w-1 aspect-h-1">
                            <img
                            ...
                            />
                            <div className="hiddn hover:absolute top-0 left-0 h-fit text-white py-2">
